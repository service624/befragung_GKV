...
def render_bottom_settings_expander(settings: Dict[str, Any]) -> Dict[str, Any]:
...
uploaded_file = st.file_uploader(
    str(app_settings.get("upload_label", "Excel-Datei hochladen")),
    type=["xlsx", "xlsm", "xls"],
)

st.markdown('<div style="height: 1rem;"></div>', unsafe_allow_html=True)
render_bottom_settings_expander(app_settings)
