...
def write_answers_to_excel_result_workbook(excel_path: Any, answers: Dict[str, Any]) -> None:
...
def read_excel_results(excel_path: Any) -> Dict[str, Any]:
    workbook_path = Path(str(excel_path))
...
def calculate_results_via_excel(excel_path: Any, answers: Dict[str, Any]) -> Dict[str, Any]:
    write_answers_to_excel_result_workbook(excel_path, answers)
    return read_excel_results(excel_path)
