...
def load_questions_from_excel(uploaded_file) -> Tuple[Dict[str, Question], str]:
    ...
    # Standard: breite Struktur aus Sheet "Tabelle1"
    for _, row in df.iterrows():
        ...
        # 1) Excel-Buchstaben-Spalten, falls vorhanden
        ...
        # 2) Alternativ nach Headernamen A1 / nach A1 usw.
        if not options:
        ...
        # Fallback: keine Optionen => Eingabefeld
        if not input_type:
